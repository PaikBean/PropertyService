...
public class ClientRepositoryImpl implements ClientRepositoryCustom {
    @Override
    public List<ClientDto.ClientListResponseDto> searchClientList(Long managerId, String clinetPhoneNumber) {
        return null;
    }

    @Override
    public List<ShowingPropertySummaryDto> searchShowingPropertyList(Long clientId, Long prorpertyId) {
        return null;
    }
