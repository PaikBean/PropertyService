...
-- INSERT INTO building_address (building_address_id, address_level1_id, address_level2_id, address_level3) VALUES (1, 101, 201, 'Street 1, City A');
-- INSERT INTO building_address (building_address_id, address_level1_id, address_level2_id, address_level3) VALUES (2, 102, 202, 'Street 2, City B');
--
-- -- Building 테이블에 더미 데이터
-- INSERT INTO building (building_id, owner_id, building_address_id) VALUES (1, 1, 1);
-- INSERT INTO building (building_id, owner_id, building_address_id) VALUES (2, 2, 2);
--
